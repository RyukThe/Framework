...
public class Class10
{
	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException 
	{
		...
		m.findElement(By.xpath("//input[@placeholder='Username']")).sendKeys(sh.getRow(0).getCell(0).getStringCellValue());
		m.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys(sh.getRow(0).getCell(1).getStringCellValue());
